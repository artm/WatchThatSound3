...
class WtsAudio : public QObject
{
    Q_OBJECT
public:
    class BufferAt : public Synced
    {
    public:
        BufferAt(QObject * parent = 0) : Synced(0, parent), m_buffer(0), m_playOffset(0) {}
        BufferAt(SoundBuffer * buffer, qint64 at, QObject * parent = 0) : Synced(at, parent), m_buffer(buffer), m_playOffset(0) {}
